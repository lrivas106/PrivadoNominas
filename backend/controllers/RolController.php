...
use backend\models\seguridad\search\RolSearch;
...
class RolController extends BaseController
{
    ...
    public function actionCreate()
    {
        ...
        $model = new Rol();  
         ...
         $tipoOperaciones = Operacion::find()->all(); //Icluyendo listado de operaciones
    ...
    public function actionUpdate($id)
    {
        $request = Yii::$app->request;
        $model = $this->findModel($id); 
        $tipoOperaciones = Operacion::find()->all(); //asignando listado de operaciones a una variable    
...
$model->operaciones = \yii\helpers\ArrayHelper::getColumn(
    ...
    {        
        ...
        foreach (Rol::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }

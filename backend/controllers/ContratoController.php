...
use backend\models\search\ContratoSearch;
...
class ContratoController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    ...
                    'footer'=> Html::button('©',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Crear Nuevo Contrato",
                    'content'=>'<span class="text-success">Create Contrato success</span>',
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->idcontrato]);
            } else {
    ...
    {        
        ...
        foreach (Contrato::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }

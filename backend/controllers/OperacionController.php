...
class OperacionController extends BaseController
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new Operacion",
                    'content'=>'<span class="text-success">Create Operacion success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Operacion model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Operacion model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (Operacion::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }

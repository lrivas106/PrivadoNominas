...
use backend\models\search\TipopagoSearch;
...
class TipopagoController extends Controller
{
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    'forceReload'=>'true',
                    'title'=> "Create new Tipopago",
                    'content'=>'<span class="text-success">Create Tipopago success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
            ...
            */
            if ($model->load($request->post()) && $model->save()) {
                return $this->redirect(['view', 'id' => $model->idtipopago]);
            } else {
    ...
    /**
     * Delete an existing Tipopago model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Tipopago model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {        
        ...
        foreach (Tipopago::findAll(json_decode($pks)) as $model) {
            $model->delete();
        }

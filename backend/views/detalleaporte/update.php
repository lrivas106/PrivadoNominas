...
$modelAporte = Aporte::find()->where(['idaporte'=>$model->idaporte])->one();



$this->title = Yii::t('app', 'Actualizar '.$modelAporte->nombre, [
    'modelClass' => 'Actualizar Aporte',
]) . ' ' ;
$this->params['breadcrumbs'][] = ['label' => Yii::t('app', 'Aportexdetalles'), 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => $model->iddetalle, 'url' => ['view', 'iddetalle' => $model->iddetalle, 'idaporte' => $model->idaporte]];
...
<div class="aportexdetalle-update">

...
/**
 * Aportepordetalle represents the model behind the search form about `backend\models\Aportexdetalle`.
 */
class Aportepordetalle extends Aportexdetalle
{
    /**
     * @inheritdoc
     */

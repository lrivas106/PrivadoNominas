...
/**
 * DescuentoxdetalleSearch represents the model behind the search form about `backend\models\Descuentoxdetalle`.
 */
class DescuentoxdetalleSearch extends Descuentoxdetalle
{
    /**
     * @inheritdoc
     */
